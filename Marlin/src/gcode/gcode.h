 ...
 *        Set Polargraph draw area and belt length: "M665 S<segments-per-second> L<work-area-left> R<work-area-right> T<work-area-top> B<work-area-bottom> H<max-belt-length>"
